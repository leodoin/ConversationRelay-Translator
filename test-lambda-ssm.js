...
// Create a test function to test SSM parameter access
async function testSSMParameterAccess() {
  // Create a payload that only tests parameter access
  const testPayload = {
    action: 'testSSM',
    parameterName: '/translation/DEEPL_API_KEY'
  };
